...
const Message = (props: {my?: boolean}): ReactElement => {
	...
	return (
		<Flex
			...
			ai={AI.flexStart}
			styles={{
				alignSelf: props.my ? 'flex-end' : 'flex-start',
				marginBottom: scaleSize(16)
			}}
			dir={props.my ? 'row-reverse' : 'row'}
		>
			{
				props.my ? null :
					<Flex styles={[styles.messageAvatar]}>
			...
			<Flex styles={[
			  styles.messageText,
				{
					backgroundColor: props.my ? colors.PRIMARY : colors.SECOND_BG,
					[`margin${props.my ? 'Left' : 'Right'}`]: scaleSize(14)
				}]}>
				<Text color={props.my ? Colors.SECOND_BG : Colors.FONT}>
          Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore
				</Text>
			</Flex>
   
			<Text color={Colors.FONT_SECOND} styles={{paddingTop: 8}}>7:54 AM</Text>
		</Flex>
	);
};
